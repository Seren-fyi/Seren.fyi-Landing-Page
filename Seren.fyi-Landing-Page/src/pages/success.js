    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      <main>
        ...
        <div className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 pb-8 mb-16 pt-10 sm:pb-28 lg:flex lg:px-8 lg:pt-40">
            <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              <img className="h-16" src="/serenlogo.png" alt="Your Company" />
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Get ready for exciting updates and early access offers delivered
                straight to your inbox once we launch.
              </p>
              <div className="mt-6">
                <Link
                  href="/"
                  className="text-sm font-semibold leading-7 text-[#ad6f26]"
                >
