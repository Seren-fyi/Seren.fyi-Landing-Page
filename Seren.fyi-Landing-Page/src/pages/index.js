          ...
          <div className="mx-auto max-w-7xl px-6 pb-8 pt-10 sm:pb-28 lg:flex lg:px-8 lg:pt-40">
            <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              ...
              <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
                Unleashing creativity beyond boundaries - powered by AI
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Experience the future of collaboration in a diverse, AI-enhanced
                platform where your projects thrive and networks expand,
